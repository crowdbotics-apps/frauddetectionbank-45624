"""
Django settings for frauddetectionbank_45624 project.
...
ROOT_URLCONF = 'frauddetectionbank_45624.urls'
...
WSGI_APPLICATION = 'frauddetectionbank_45624.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "frauddetectionbank_45624 API",
    "DESCRIPTION": "API documentation for frauddetectionbank_45624 App",
    "VERSION": "v1",
}
